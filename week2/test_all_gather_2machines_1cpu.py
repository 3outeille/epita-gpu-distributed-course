'''
- To simulate multi-nodes
torchrun --nproc_per_node 1 --nnodes 2 --node_rank 0 test_all_gather_2machines_1cpu.py
torchrun --nproc_per_node 1 --nnodes 2 --node_rank 1 test_all_gather_2machines_1cpu.py
'''
import torch 
...
local_rank = int(os.environ["LOCAL_RANK"]) # au sein d'une machine
...
# local_rank = dist.get_rank() # get_rank() -> global rank
